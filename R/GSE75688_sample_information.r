#'@title Information of the samples in GSE75688_TPM dataset
...
#'@docType data
#'@usage GSE75688_sample_information
#'@format A \code{dataframe} with 528 observations (rows) and 5 variables (columns).
